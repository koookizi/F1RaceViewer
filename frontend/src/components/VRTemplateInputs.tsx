    ...
    <div className={`mt-3 space-y-3 ${className}`}>
      ...
      {requires.topN && (
        <div className="form-control w-100">
          <label className="label py-1">
            <span className="label-text text-sm">Top N</span>
          </label>
          <input
            type="number"
            className="input input-sm input-bordered"
      ...
      {requires.season && (
        <div className="form-control w-100">
          <label className="label py-1">
            <span className="label-text text-sm">Season</span>
          </label>
          <input
            type="number"
            className="input input-sm input-bordered"
      ...
      {requires.telemetryCompare && (
        <div className="space-y-2">
          ...
          <div className="divider my-1">Telemetry options</div>

          <div className="form-control w-100">
            <label className="label py-1">
              <span className="label-text text-sm">Align by</span>
            </label>
            <select
              className="select select-sm select-bordered"
